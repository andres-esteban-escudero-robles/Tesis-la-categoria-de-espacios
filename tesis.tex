...
\begin{proof}
  ...
  \begin{equation*}
    ...
    \end{tikzcd}
  \end{equation*}
  Nuevamente, debido a \ref{cor:unidadidentidad} las componentes de $c$ en espacios discretos tienen que ser identidades,
  lo cual nos da la conmutatividad del triángulo izquierdo. 
