...
\begin{proof}
  ...
  \begin{equation*}
    \begin{tikzcd}
      1\ar{r}{a} \ar{rd}{id} & A\ar{r}{i_A} & A+\lnot A \ar{r} & A\cup\lnot A\ar[tail]{r}{m} &1 \\
        & 1\ar{urrr}
    \end{tikzcd}
  \end{equation*}
...
\end{theorem}
\begin{proof}
  Primero mostremos que $\mathcal{E}_C$ tiene límites finitos, para ello es suficiente mostrar
  que tiene productos e igualadores finitos. Como $\mathcal{E}$ tiene productos y $G$ es
  funtor, dadas $(A,s),(B,t)$ coálgebras de $C$ tenemos:
  \begin{equation*}
    \begin{tikzcd}
    ...
    \end{tikzcd}
  \end{equation*}
  En este caso, gracias a que $G$ es izquierdo exacto, $\phi$ es un isomorfismo. Proponemos
  ...
  \begin{equation*}
    \begin{tikzcd}
      A\times B\ar[phantom]{rd}{(1)}\ar{r}{s\times t}\ar{d}{s\times t} & GA\times GB\ar{r}{\phi^{-1}}\ar{d}{\delta_A\times \delta_B}
        & G(A\times B)\ar{dd}{\delta_{A\times B}} \\
      GA\times GB\ar{r}{G(s)\times G(t)}\ar{d}{\phi^{-1}} & G^2A\times G^2B\ar{d}{\psi^{-1}} \\
      G(A\times B)\ar[phantom]{ur}{(2)}\ar{r}{G(s\times t)} & G(GA\times GB)\ar[phantom]{uur}{(3)}\ar{r}{G(\phi^{-1})} & G^2(A\times B)
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      GA\ar{d}{G(s)} & GA\times GB\ar{l}{\pi_{GA}}\ar{r}{\pi_{GB}}\ar[dashed]{d}{G(s)\times G(t)} & GB\ar{d}{G(t)}\\
      G^2A & G^2A\times G^2B\ar{l}{\pi_{G^2A}}\ar{r}{\pi_{G^2B}} & G^2B \\
      G^2A\ar{u}{id_{G^2A}} & G(GA\times GB)\ar{l}{G(\pi_{GA})}\ar{u}{\psi}\ar{r}{G(\pi_{GB})} & G^2B\ar{u}{id_{G^2B}} \\
      GA\ar{u}{G(s)} & G(A\times B)\ar{l}{G(\pi_A)}\ar{u}{G(s\times t)}\ar{r}{G(\pi_B)} & GB\ar{u}{G(t)} \\
      & GA\times GB\ar{ul}{\pi_{GA}}\ar{u}{\phi^{-1}}\ar{ur}{\pi_{GB}}
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      ...
      GA\times GB\ar{ur}{\pi_{GB}}\ar{r}{\phi^{-1}}\ar{dr}{\pi_A} & G(A\times B)\ar{u}{G(\pi_B)}\ar{r}{\delta_{A\times B}}\ar{d}{G(\pi_A)}
        & G^2(A\times B)\ar{u}{G^2(\pi_B)}\ar{r}{\psi G(\phi)}\ar{d}{G^2(\pi_A)}
  ...
  \begin{equation*}
    \begin{tikzcd}
      X\ar{d}{u}\ar{r}{f\times g} & A\times B\ar{dr}{\phi^{-1}(s\times t)}\ar{d}{s\times t} \\
  ...
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{e}\ar[dashed]{d}{u} & A\ar[shift left=0.75ex]{r}{f}\ar[swap, shift right=0.75ex]{r}{g}\ar{d}{s} & B\ar{d}{t} \\
      GE\ar{r}{G(e)} & GA\ar[shift left=0.75ex]{r}{G(f)}\ar[swap, shift right=0.75ex]{r}{G(g)} & GB \\
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{e} & A\ar[shift left=0.75ex]{r}{f}\ar[swap, shift right=0.75ex]{r}{g} & B & {} E\ar{r}{e}\ar{d}{u} & A\ar{r}{id_A}\ar{d}{s} & A \\
      GE\ar[dashed]{u}{\epsilon_E}\ar{r}{G(e)} & GA\ar[shift left=0.75ex]{r}{G(f)}\ar[swap, shift right=0.75ex]{r}{G(g)}\ar{u}{\epsilon_A} & GB\ar{u}{\epsilon_B} & {} GE\ar{r}{G(e)} & GA\ar[swap]{ur}{\epsilon_A} \\
      E\ar{u}{u}
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{u}\ar{d}{u} & GE\ar{d}{\delta_E} \\
      GE\ar{r}{G(u)} & G^2E
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      ...
      E\ar{u}{e}\ar{r}{u} & GE\ar[shift left=0.75ex]{r}{G(u)}\ar[swap, shift right=0.75ex]{r}{\delta_E}\ar{u}{G(e)} & G^2E\ar[swap]{u}{G^2(e)}
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{e}\ar{d}{u} & A\ar[shift left=0.75ex]{r}{f}\ar[swap, shift right=0.75ex]{r}{g}\ar{d}{s} & B\ar{d}{t} \\
      GE\ar{r}{G(e)} & GA\ar[shift left=0.75ex]{r}{G(f)}\ar[swap, shift right=0.75ex]{r}{G(g)} & GB
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      X\ar[dashed]{r}{j}\ar{d}{w} & E\ar{d}{u} \\
      GX\ar[dashed]{r}{k} & GE
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      ...
      X\ar{u}{w}\ar[swap]{uur}{G(h)w} & {} & X\ar{u}{j}\ar{ur}{h}\ar{rr}{w} & {} & GX\ar{uu}{G(h)}
    \end{tikzcd}
  \end{equation*}
...
\begin{proof}
  ...
  \begin{equation*}
    \begin{tikzcd}
      \Delta S\ar{r}{!}\ar[tail]{d}{\Delta m} & 1\ar{d}{v} \\
  ...
  \begin{equation*}
    \begin{tikzcd}
      S\ar{r}{!}\ar[tail]{d}{m} & 1\ar{d}{\Gamma v} \\
  ...
  \begin{equation*}
    \begin{tikzcd}
      S\ar{r}{!}\ar[tail]{d}{m} & \Delta\Gamma 1\ar{d}{\Delta\Gamma v}\ar{r}{c_1} & 1\ar{d}{v} \\
      A\ar[shift left=0.75ex]{r}{f}\ar[swap,shift right=0.75ex]{r}{\Gamma \chi_m} & \Delta\Gamma\Omega\ar[tail]{r}{c_{\Omega}} & \Omega
    \end{tikzcd}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{tikzcd}
      X\ar[bend left=30]{rrd}{!}\ar[bend right=30]{rdd}[swap]{p}
          \ar[dashed]{rd}{!}\\[-2ex]
      &[-2ex] \Delta\Gamma 1\ar{r}{c_1}\ar{d}{\Delta\Gamma v} & 1\ar{d}{v} \\
