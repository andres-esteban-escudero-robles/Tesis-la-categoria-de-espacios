...
\begin{proof}
  ...
  \begin{equation*}
    \begin{tikzcd}
      1\ar{r}{i_1}\ar[swap]{rdd}{ai_1}\ar{rd}{o} & 1+N\ar{d}{[o,s]} & N\ar[swap]{l}{i_N}\ar{ldd}{fs}\ar{ld}{s} & {} & 1\ar{r}{i_1}\ar[swap]{rdd}{ai_1}\ar{rd}{i_1} & 1+N & N\ar{d}{}\ar[swap]{l}{i_N}\ar{ldd}{fs}\ar[swap]{ld}{i_Af} \\
        & N\ar{d}{f} & {} & {} & {} & 1+A\ar{d}{a} & {} \\
        & A & {} & {} & {} & A. & {}
    \end{tikzcd}
  \end{equation*}
