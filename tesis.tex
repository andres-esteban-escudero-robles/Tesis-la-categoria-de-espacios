...
\begin{proof}
  ...
  $(B,t)$ coálgebras y $f,g:(A,s)\to (B,t)$. Proponemos $(E,\phi^{-1}u)$ como sigue:
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{e}\ar[dashed]{d}{u} & A\ar[shift left=0.75ex]{r}{f}\ar[swap, shift right=0.75ex]{r}{g}\ar{d}{s} & B\ar{d}{t} \\
      D\ar{r}{d} & GA\ar[shift left=0.75ex]{r}{G(f)}\ar[swap, shift right=0.75ex]{r}{G(g)} & GB \\
      GE\ar[dashed]{u}{\phi}\ar{ur}{G(e)}
    \end{tikzcd}
  \end{equation*}
  Los cuadros conmutan ya que $f$ y $g$ son morfismos de coálgebras, entonces $se$ iguala
  a $G(f)$ con $G(g)$, lo cual nos da la existencia de $u$. De nuevo, $\phi$ es un
  isomorfismo porque $G$ preserva límites. Veamos que $(E,\phi^{-1}u)$ es coálgebra, para
  ello empezamos con la ``counidad'' , es decir, queremos demostrar la conmutatividad del siguiente diagrama:
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{\phi^{-1}u}\ar{dr}{id_E} & GE\ar{d}{\epsilon_E} \\
      & E
    \end{tikzcd}
  \end{equation*}
  Notemos que $\epsilon_AG(e)$ iguala a $f,g$.
  \begin{equation*}
    \begin{tikzcd}
      E\ar{r}{e} & A\ar[shift left=0.75ex]{r}{f}\ar[swap, shift right=0.75ex]{r}{g} & B \\
      GE\ar[dashed]{u}{\epsilon_E}\ar{r}{G(e)} & GA\ar[shift left=0.75ex]{r}{G(f)}\ar[swap, shift right=0.75ex]{r}{G(g)}\ar{u}{\epsilon_A} & GB\ar{u}{\epsilon_B} \\
      E\ar{u}{\phi^{-1}u}
    \end{tikzcd}
  \end{equation*}
\end{proof}
