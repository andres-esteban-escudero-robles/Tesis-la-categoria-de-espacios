...
\begin{proof}
  ...
  lo cual se puede pensar como un isomorfismo natural $Id:\Delta\Gamma\to \Delta\Gamma\Delta\Gamma$, cuyas componentes son identidades. En esta prueba 
  $c$ es la counidad de la adjunción $\Delta\dashv\Gamma$, es decir, $c:\Delta\Gamma\to Id_{Espacios}$ que construimos en \ref{thm:funtordiscretos}.
...
\begin{proof}
  ...
  $F:M\to Espacios_{\mathcal{C}}$ que envía a cada espacio discreto $D$ a la coálgebra 
  $(\Delta D, u_D)$, donde $u:Id\to\Delta\Gamma$ es la unidad de la adjunción, y en 
  ...
  Además, dejar igual a los morfismos resulta en morfismos de coálgebras ya que si $f:D\to D'$
  ...
  Por tanto, $F$ es funtorial ya que no hace nada en morfismos. Ahora, proponemos al funtor inverso $G:Espacios_{\mathcal{C}}\to M$ 
  que envía a cada coálgebra $(A,s)$ a $\Gamma A$ y a cada morfismo de coálgebras $f:(A,s)\to (B,t)$ a $\Gamma f$.
